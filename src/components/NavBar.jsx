    ...
    <>
      ...
      <nav className={`fixed top-0 z-50 w-full transition-all duration-700 ${scrolled ? "pt-2" : "pt-8"}`}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className={`relative flex items-center justify-between rounded-[24px] border px-4 py-2.5 backdrop-blur-3xl transition-all duration-500 ${
            scrolled 
            ...
            <Link to="/" className="flex items-center gap-3 pl-2 group">
              ...
              <div className="hidden sm:flex flex-col">
                <h1 className="text-xl font-black tracking-tighter text-white italic">DIDAR<span className="text-cyan-400">.</span>CORE</h1>
                <span className="text-[8px] font-mono font-bold text-neutral-500 uppercase tracking-[0.4em] -mt-1">Protocols_Active</span>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-3">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="#contact"
                className="hidden sm:flex items-center gap-2 px-6 py-2.5 bg-white rounded-xl text-[10px] font-black uppercase tracking-widest text-black transition-all hover:bg-cyan-400"
              >
                <FaHandshake size={14} />
                Connect
              </motion.a>
